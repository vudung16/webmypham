import {
  require_vue
} from "./chunk-SJH6DGN5.js";
import "./chunk-2FKQQDEQ.js";
import {
  __commonJS,
  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var f = function() {
      ...
      return r(t2, [{ key: "setEasingFunctions", value: function() {
        ...
        (!s2 || s2.indexOf("undefined") > -1 || s2.indexOf("NaN") > -1) && (s2 = c2()), (!r2 || r2.indexOf("undefined") > -1 || r2.indexOf("NaN") > -1) && (r2 = c2()), h2.globals.shouldAnimate || (o2 = 1), t3.plot(s2).animate(1, h2.globals.easing, n2).plot(s2).animate(o2, h2.globals.easing, n2).plot(r2).afterAll(function() {
          p.isNumber(i2) ? i2 === h2.globals.series[h2.globals.maxValsInArrayIndex].length - 2 && h2.globals.shouldAnimate && l2.animationCompleted(t3) : a2 !== "none" && h2.globals.shouldAnimate && (!h2.globals.comboCharts && e2 === h2.globals.series.length - 1 || h2.globals.comboCharts) && l2.animationCompleted(t3), l2.showDelayedElements();
        });
      } }]), t2;
    }();
    var x = function() {
      ...
      return r(t2, [{ key: "getDefaultFilter", value: function(t3, e2) {
        ...
        return t3.unfilter(true), p.isIE() && h2.config.chart.type === "radialBar" || (o2 = Array.isArray(o2) ? o2[i2] : o2, t3.filter(function(t4) {
          var e3 = null;
    ...
    var b = function() {
      ...
      return r(t2, [{ key: "drawLine", value: function(t3, e2, i2, a2) {
        ...
        var i2, a2 = t3.j, s2 = t3.realIndex, r2 = t3.pathFrom, o2 = t3.pathTo, n2 = t3.stroke, l2 = t3.strokeWidth, h2 = t3.strokeLinecap, c2 = t3.fill, d2 = t3.animationDelay, g2 = t3.initialSpeed, u2 = t3.dataChangeSpeed, p2 = t3.className, b2 = t3.shouldClipToGrid, v2 = b2 === void 0 || b2, m2 = t3.bindEventsOnPaths, y2 = m2 === void 0 || m2, w2 = t3.drawShadow, k2 = w2 === void 0 || w2, A2 = this.w, S2 = new x(this.ctx), C2 = new f(this.ctx), L2 = this.w.config.chart.animations.enabled, P2 = L2 && this.w.config.chart.animations.dynamicAnimation.enabled, T2 = !!(L2 && !A2.globals.resized || P2 && A2.globals.dataChanged && A2.globals.shouldAnimate);
        ...
        if (z2.attr("index", s2), v2 && z2.attr({ "clip-path": "url(#gridRectMask".concat(A2.globals.cuid, ")") }), A2.config.states.normal.filter.type !== "none")
        ...
        e2.length < 9 && e2.indexOf("#") === 0 && (e2 = p.hexToRgba(e2, a2)), i2.length < 9 && i2.indexOf("#") === 0 && (i2 = p.hexToRgba(i2, s2));
        ...
        var e2, i2 = t3.x, a2 = t3.y, s2 = t3.text, r2 = t3.textAnchor, o2 = t3.fontSize, n2 = t3.fontFamily, l2 = t3.fontWeight, h2 = t3.foreColor, c2 = t3.opacity, d2 = t3.cssClass, g2 = d2 === void 0 ? "" : d2, u2 = t3.isPlainText, p2 = u2 === void 0 || u2, f2 = this.w;
        return s2 === void 0 && (s2 = ""), r2 || (r2 = "start"), h2 && h2.length || (h2 = f2.config.chart.foreColor), n2 = n2 || f2.config.chart.fontFamily, l2 = l2 || "regular", (e2 = Array.isArray(s2) ? f2.globals.dom.Paper.text(function(t4) {
        ...
        if (i2.shape === "square" || i2.shape === "rect") {
          ...
          i2.shape !== "circle" && i2.shape || (p.isNumber(e2) || (a2 = 0, e2 = 0), s2 = this.drawCircle(a2, { cx: t3, cy: e2, class: i2.class ? i2.class : "", stroke: i2.pointStrokeColor, fill: i2.pointFillColor, "fill-opacity": i2.pointFillOpacity ? i2.pointFillOpacity : 1, "stroke-width": i2.pointStrokeWidth ? i2.pointStrokeWidth : 0, "stroke-opacity": i2.pointStrokeOpacity ? i2.pointStrokeOpacity : 1 }));
        return s2;
    ...
    var v = function() {
      ...
      return r(t2, [{ key: "setOrientations", value: function(t3) {
        ...
        return e2.id && d2.node.classList.add(p.escapeString(e2.id)), d2;
    ...
    var m = function() {
      ...
      return r(t2, [{ key: "addXaxisAnnotation", value: function(t3, e2, i2) {
        ...
        a2.config.xaxis.type !== "category" && !a2.config.xaxis.convertedCatToNumeric || this.invertAxis || a2.globals.dataFormatXNumeric || (n2 = this.annoCtx.helpers.getStringX(t3.x));
        ...
        if (p.isNumber(n2)) {
          if (t3.x2 === null || t3.x2 === void 0) {
            ...
            if (this.annoCtx.inversedReversedAxis && (d2 = (r2 - t3.x2) / (o2 / a2.globals.gridWidth)), a2.config.xaxis.type !== "category" && !a2.config.xaxis.convertedCatToNumeric || this.invertAxis || a2.globals.dataFormatXNumeric || (d2 = this.annoCtx.helpers.getStringX(t3.x2)), d2 < n2) {
              var g2 = n2;
              n2 = d2, d2 = g2;
            }
          ...
          var f2 = t3.label.position === "top" ? 4 : a2.globals.gridHeight, x2 = this.annoCtx.graphics.getTextRects(l2, parseFloat(t3.label.style.fontSize)), b2 = this.annoCtx.graphics.drawText({ x: n2 + t3.label.offsetX, y: f2 + t3.label.offsetY - (t3.label.orientation === "vertical" ? t3.label.position === "top" ? x2.width / 2 - 12 : -x2.width / 2 : 0), text: l2, textAnchor: t3.label.textAnchor, fontSize: t3.label.style.fontSize, fontFamily: t3.label.style.fontFamily, fontWeight: t3.label.style.fontWeight, foreColor: t3.label.style.color, cssClass: "apexcharts-xaxis-annotation-label ".concat(t3.label.style.cssClass, " ").concat(t3.id ? t3.id : "") });
    ...
    var y = function() {
      ...
      return r(t2, [{ key: "getStackedSeriesTotals", value: function() {
        ...
        var i2 = this.w, a2 = (Math.log(t3) - Math.log(i2.globals.minYArr[e2])) / (Math.log(i2.globals.maxYArr[e2]) - Math.log(i2.globals.minYArr[e2]));
        return isNaN(a2) ? t3 : a2;
    ...
    var k = function() {
      ...
      return r(t2, [{ key: "addPointAnnotation", value: function(t3, e2, i2) {
        ...
        if (typeof t3.x == "string" || a2.config.xaxis.type === "category" || a2.config.xaxis.convertedCatToNumeric) {
          var l2 = a2.globals.labels.indexOf(t3.x);
          a2.config.xaxis.convertedCatToNumeric && (l2 = a2.globals.categoryLabels.indexOf(t3.x)), s2 = this.annoCtx.helpers.getStringX(t3.x), t3.y === null && (n2 = a2.globals.series[t3.seriesIndex][l2]);
        } else
        ...
        for (var h2, c2 = [], d2 = 0, g2 = 0; g2 <= t3.seriesIndex; g2++) {
          ...
          if (u2)
            for (var f2 = g2 + 1; f2 <= t3.seriesIndex; f2++)
              a2.config.yaxis[f2].seriesName === u2 && c2.indexOf(u2) === -1 && (d2++, c2.push(u2));
        }
        ...
        if (r2 = a2.globals.gridHeight - h2 - parseFloat(t3.label.style.fontSize) - t3.marker.size, o2 = a2.globals.gridHeight - h2, a2.config.yaxis[t3.yAxisIndex] && a2.config.yaxis[t3.yAxisIndex].reversed && (r2 = h2 + parseFloat(t3.label.style.fontSize) + t3.marker.size, o2 = h2), p.isNumber(s2)) {
          ...
          if (t3.image.path) {
            ...
            v2 = this.annoCtx.addImage({ x: s2 + t3.image.offsetX - A2 / 2, y: r2 + t3.image.offsetY - S2 / 2, width: A2, height: S2, path: t3.image.path, appendTo: ".apexcharts-point-annotations" });
          }
          t3.mouseEnter && v2.node.addEventListener("mouseenter", t3.mouseEnter.bind(this, t3)), t3.mouseLeave && v2.node.addEventListener("mouseleave", t3.mouseLeave.bind(this, t3));
        }
    ...
    var C = function() {
      ...
      return r(t2, [{ key: "drawAxesAnnotations", value: function() {
        ...
        var i2 = this.w, a2 = t3.path, s2 = t3.x, r2 = s2 === void 0 ? 0 : s2, o2 = t3.y, n2 = o2 === void 0 ? 0 : o2, l2 = t3.width, h2 = l2 === void 0 ? 20 : l2, c2 = t3.height, d2 = c2 === void 0 ? 20 : c2, g2 = t3.appendTo, u2 = g2 === void 0 ? ".apexcharts-annotations" : g2, p2 = i2.globals.dom.Paper.image(a2);
    ...
    var L = function() {
      ...
      return r(t2, [{ key: "clippedImgArea", value: function(t3) {
        ...
        var h2 = o2;
        if (o2.indexOf("rgb") === -1 ? o2.length < 9 && (h2 = p.hexToRgba(o2, l2)) : o2.indexOf("rgba") > -1 && (l2 = p.getOpacityFromRGBA(o2)), t3.opacity && (l2 = t3.opacity), n2 === "pattern" && (a2 = this.handlePatternFill(a2, o2, l2, h2)), n2 === "gradient" && (s2 = this.handleGradientFill(o2, l2, this.seriesIndex)), n2 === "image") {
        ...
        var s2 = this.w.config, r2 = this.opts, o2 = new b(this.ctx), n2 = s2.fill.pattern.strokeWidth === void 0 ? Array.isArray(s2.stroke.width) ? s2.stroke.width[this.seriesIndex] : s2.stroke.width : Array.isArray(s2.fill.pattern.strokeWidth) ? s2.fill.pattern.strokeWidth[this.seriesIndex] : s2.fill.pattern.strokeWidth, l2 = e2;
        ...
        var a2, s2 = this.w.config, r2 = this.opts, o2 = new b(this.ctx), n2 = new p(), l2 = s2.fill.gradient.type, h2 = t3, c2 = s2.fill.gradient.opacityFrom === void 0 ? e2 : Array.isArray(s2.fill.gradient.opacityFrom) ? s2.fill.gradient.opacityFrom[i2] : s2.fill.gradient.opacityFrom;
        ...
        if (s2.fill.gradient.gradientToColors === void 0 || s2.fill.gradient.gradientToColors.length === 0)
          a2 = s2.fill.gradient.shade === "dark" ? n2.shadeColor(-1 * parseFloat(s2.fill.gradient.shadeIntensity), t3.indexOf("rgb") > -1 ? p.rgb2hex(t3) : t3) : n2.shadeColor(parseFloat(s2.fill.gradient.shadeIntensity), t3.indexOf("rgb") > -1 ? p.rgb2hex(t3) : t3);
    ...
    var P = function() {
      ...
      return r(t2, [{ key: "setGlobalMarkerSize", value: function() {
        ...
        var s2, r2 = arguments.length > 4 && arguments[4] !== void 0 && arguments[4], o2 = this.w, n2 = e2, l2 = t3, h2 = null, c2 = new b(this.ctx);
        if ((o2.globals.markers.size[e2] > 0 || r2) && (h2 = c2.group({ class: r2 ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(o2.globals.cuid, ")")), Array.isArray(l2.x))
          for (var d2 = 0; d2 < l2.x.length; d2++) {
            ...
            o2.config.chart.type !== "line" && o2.config.chart.type !== "area" || o2.globals.comboCharts || o2.config.tooltip.intersect || (u2 += " no-pointer-events");
            ...
            if (f2 || r2) {
              ...
              o2.globals.pointsArray[e2] === void 0 && (o2.globals.pointsArray[e2] = []), o2.globals.pointsArray[e2].push([l2.x[d2], l2.y[d2]]);
          }
        return h2;
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (h2.attr("clip-path", "url(#gridRectMarkerMask".concat(a2.globals.cuid, ")")), Array.isArray(o2.x))
          for (var c2 = 0; c2 < o2.x.length; c2++) {
            ...
            if (u2 = u2 || 0, v2 !== null && a2.globals.series[r2][d2] !== void 0 || (g2 = false), g2) {
        ...
        var n2 = this.w, l2 = s2, h2 = new f(this.ctx), c2 = new x(this.ctx), d2 = new L(this.ctx), g2 = new P(this.ctx), u2 = new b(this.ctx), p2 = g2.getMarkerConfig({ cssClass: "apexcharts-marker", seriesIndex: l2, dataPointIndex: r2, finishRadius: n2.config.chart.type === "bubble" || n2.globals.comboCharts && n2.config.series[s2] && n2.config.series[s2].type === "bubble" ? a2 : null });
        a2 = p2.pSize;
        ...
        if (!this.initialAnim || n2.globals.dataChanged || n2.globals.resized)
          ...
          h2.animateMarker(v2, 0, p2.shape === "circle" ? a2 : { width: p2.width, height: p2.height }, w2, n2.globals.easing, function() {
            window.setTimeout(function() {
              h2.animationCompleted(v2);
            }, 100);
          });
        }
        if (n2.globals.dataChanged && p2.shape === "circle")
          if (this.dynamicAnim) {
            ...
            t3 === 0 && e2 === 0 && (a2 = 0), h2.animateCircle(v2, { cx: k2, cy: A2, r: S2 }, { cx: t3, cy: e2, r: a2 }, T2, n2.globals.easing);
          } else
            v2.attr({ r: a2 });
    ...
    var M = function() {
      ...
      return r(t2, [{ key: "dataLabelsCorrection", value: function(t3, e2, i2, a2, s2, r2, o2) {
        ...
        var a2 = this, s2 = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 2, r2 = this.w, o2 = new b(this.ctx), n2 = r2.config.dataLabels, l2 = 0, h2 = 0, c2 = i2, d2 = null;
        ...
        if (!(Array.isArray(e2.config.dataLabels.enabledOnSeries) && e2.config.dataLabels.enabledOnSeries.indexOf(r2) < 0)) {
          ...
          ((e2.config.chart.type === "bar" || e2.config.chart.type === "rangeBar") && e2.config.plotOptions.bar.distributed || e2.config.dataLabels.distributed) && (v2 = e2.globals.dataLabels.style.colors[o2]), typeof v2 == "function" && (v2 = v2({ series: e2.globals.series, seriesIndex: r2, dataPointIndex: o2, w: e2 })), g2 && (v2 = g2);
          var m2 = d2.offsetX, y2 = d2.offsetY;
          if (e2.config.chart.type !== "bar" && e2.config.chart.type !== "rangeBar" || (m2 = 0, y2 = 0), f2.drawnextLabel) {
        ...
        var i2 = this.w, a2 = i2.config.dataLabels.background, s2 = a2.padding, r2 = a2.padding / 2, o2 = e2.width, n2 = e2.height, l2 = new b(this.ctx).drawRect(e2.x - s2, e2.y - r2 / 2, o2 + 2 * s2, n2 + r2, a2.borderRadius, i2.config.chart.background === "transparent" ? "#fff" : i2.config.chart.background, a2.opacity, a2.borderWidth, a2.borderColor);
    ...
    var I = function() {
      ...
      return r(t2, [{ key: "handleBarDataLabels", value: function(t3) {
        ...
        d2 !== void 0 && this.barCtx.isRangeBar && (m2 = d2, w2 = d2);
        ...
        if (c2.enabled && !v2) {
          ...
          var m2 = "";
          s2 !== void 0 && (m2 = f2(s2, { seriesIndex: r2, dataPointIndex: o2, w: d2 }));
          ...
          var k2 = e({}, c2);
          this.barCtx.isHorizontal && s2 < 0 && (c2.textAnchor === "start" ? k2.textAnchor = "end" : c2.textAnchor === "end" && (k2.textAnchor = "start")), u2.plotDataLabelsText({ x: i2, y: a2, text: m2, i: r2, j: o2, parent: x2, dataLabelsConfig: k2, alwaysDrawDataLabel: true, offsetCorrection: true });
        }
        return x2;
      } }]), t2;
    }();
    var z = function() {
      ...
      return r(t2, [{ key: "getAllSeriesEls", value: function() {
        ...
        var t3 = !(arguments.length > 0 && arguments[0] !== void 0) || arguments[0], e2 = !(arguments.length > 1 && arguments[1] !== void 0) || arguments[1], i2 = !(arguments.length > 2 && arguments[2] !== void 0) || arguments[2], a2 = this.w, s2 = p.clone(a2.globals.initialSeries);
    ...
    var E = function() {
      function t2(e2, i2) {
        a(this, t2), this.ctx = e2, this.w = e2.w;
        var s2 = this.w;
        this.barOptions = s2.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = s2.config.stroke.width, this.isNullValue = false, this.isRangeBar = s2.globals.seriesRangeBar.length && this.isHorizontal, this.xyRatios = i2, this.xyRatios !== null && (this.xRatio = i2.xRatio, this.initialXRatio = i2.initialXRatio, this.yRatio = i2.yRatio, this.invertedXRatio = i2.invertedXRatio, this.invertedYRatio = i2.invertedYRatio, this.baseLineY = i2.baseLineY, this.baseLineInvertedY = i2.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, this.barHelpers = new X(this);
      }
      return r(t2, [{ key: "draw", value: function(t3, i2) {
        ...
        T2.count > 0 && s2 >= S2.globals.dataPoints - T2.count && (P2.node.setAttribute("stroke-dasharray", T2.dashArray), P2.node.setAttribute("stroke-width", T2.strokeWidth), P2.node.setAttribute("fill-opacity", T2.fillOpacity)), g2 !== void 0 && u2 !== void 0 && (P2.attr("data-range-y1", g2), P2.attr("data-range-y2", u2)), new x(this.ctx).setSelectionFilter(P2, e2, s2), h2.add(P2);
        ...
        return M2 !== null && y2.add(M2), h2.add(y2), w2 && h2.add(w2), h2;
    ...
    var Y = function() {
      ...
      return r(t2, [{ key: "isValidDate", value: function(t3) {
        ...
        var u2 = a2 ? t3.getUTCHours() : t3.getHours(), p2 = u2 > 12 ? u2 - 12 : u2 === 0 ? 12 : u2;
    ...
    var H = function() {
      ...
      return r(t2, [{ key: "init", value: function(t3) {
        ...
        this.chartType = a2.chart.type, this.chartType === "histogram" && (a2.chart.type = "bar", a2 = p.extend({ plotOptions: { bar: { columnWidth: "99.99%" } } }, a2)), a2 = this.extendYAxis(a2), a2 = this.extendAnnotations(a2);
        var o2 = s2.init(), n2 = {};
        if (a2 && i(a2) === "object") {
          var l2 = {};
        ...
        var a2 = new R(i2), s2 = (t3 === "bar" || t3 === "boxPlot") && i2.plotOptions && i2.plotOptions.bar && i2.plotOptions.bar.horizontal, r2 = t3 === "pie" || t3 === "polarArea" || t3 === "donut" || t3 === "radar" || t3 === "radialBar" || t3 === "heatmap", o2 = i2.xaxis.type !== "datetime" && i2.xaxis.type !== "numeric", n2 = i2.xaxis.tickPlacement ? i2.xaxis.tickPlacement : e2.xaxis && e2.xaxis.tickPlacement;
        ...
        var e2 = new S();
        return t3.annotations.yaxis = p.extendArray(t3.annotations.yaxis !== void 0 ? t3.annotations.yaxis : [], e2.yAxisAnnotation), t3;
      } }, { key: "extendXAxisAnnotations", value: function(t3) {
        var e2 = new S();
        return t3.annotations.xaxis = p.extendArray(t3.annotations.xaxis !== void 0 ? t3.annotations.xaxis : [], e2.xAxisAnnotation), t3;
      } }, { key: "extendPointAnnotations", value: function(t3) {
        var e2 = new S();
        return t3.annotations.points = p.extendArray(t3.annotations.points !== void 0 ? t3.annotations.points : [], e2.pointAnnotation), t3;
    ...
    var O = function() {
      ...
      return r(t2, [{ key: "isMultiFormat", value: function() {
        ...
        for (var i2 = this.w.config, a2 = this.w.globals, s2 = i2.chart.type === "boxPlot" || i2.series[e2].type === "boxPlot", r2 = 0; r2 < t3[e2].data.length; r2++)
          if (t3[e2].data[r2][1] !== void 0 && (Array.isArray(t3[e2].data[r2][1]) && t3[e2].data[r2][1].length === 4 && !s2 ? this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][1][3])) : t3[e2].data[r2].length >= 5 ? this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][4])) : this.twoDSeries.push(p.parseNumber(t3[e2].data[r2][1])), a2.dataFormatXNumeric = true), i2.xaxis.type === "datetime") {
        ...
        for (var o2 = 0; o2 < t3[e2].data.length; o2++)
          t3[e2].data[o2].y !== void 0 && (Array.isArray(t3[e2].data[o2].y) ? this.twoDSeries.push(p.parseNumber(t3[e2].data[o2].y[t3[e2].data[o2].y.length - 1])) : this.twoDSeries.push(p.parseNumber(t3[e2].data[o2].y))), t3[e2].data[o2].goals !== void 0 && Array.isArray(t3[e2].data[o2].goals) ? (this.seriesGoals[e2] === void 0 && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(t3[e2].data[o2].goals)) : (this.seriesGoals[e2] === void 0 && (this.seriesGoals[e2] = []), this.seriesGoals[e2].push(null));
        ...
        var e2 = this, i2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.ctx, a2 = this.w.config, s2 = this.w.globals, r2 = new Y(i2), o2 = a2.labels.length > 0 ? a2.labels.slice() : a2.xaxis.categories.slice();
        s2.isRangeBar = a2.chart.type === "rangeBar" && s2.isBarHorizontal;
        for (var n2 = function() {
    ...
    var W = function() {
      ...
      return r(t2, [{ key: "xLabelFormat", value: function(t3, e2, i2, a2) {
        ...
        var a2 = this.w;
        return p.isNumber(t3) && (t3 = a2.globals.yValueDecimal !== 0 ? t3.toFixed(e2.decimalsInFloat !== void 0 ? e2.decimalsInFloat : a2.globals.yValueDecimal) : a2.globals.maxYArr[i2] - a2.globals.minYArr[i2] < 5 ? t3.toFixed(1) : t3.toFixed(0)), t3;
    ...
    var B = function() {
      ...
      return r(t2, [{ key: "getLabel", value: function(t3, e2, i2, a2) {
        var s2 = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], r2 = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : "12px", o2 = this.w, n2 = t3[a2] === void 0 ? "" : t3[a2], l2 = n2, h2 = o2.globals.xLabelFormatter, c2 = o2.config.xaxis.labels.formatter, d2 = false, g2 = new W(this.ctx), u2 = n2;
        l2 = g2.xLabelFormat(h2, n2, u2, { i: a2, dateFormatter: new Y(this.ctx).formatDate, w: o2 }), c2 !== void 0 && (l2 = c2(n2, t3[a2], { i: a2, dateFormatter: new Y(this.ctx).formatDate, w: o2 }));
        var p2 = function(t4) {
          var i3 = null;
        ...
        e2.length > 0 ? (d2 = p2(e2[a2].unit), i2 = e2[a2].position, l2 = e2[a2].value) : o2.config.xaxis.type === "datetime" && c2 === void 0 && (l2 = ""), l2 === void 0 && (l2 = ""), l2 = Array.isArray(l2) ? l2 : l2.toString();
        ...
        return !Array.isArray(l2) && (l2.indexOf("NaN") === 0 || l2.toLowerCase().indexOf("invalid") === 0 || l2.toLowerCase().indexOf("infinity") >= 0 || s2.indexOf(l2) >= 0 && v2) && (l2 = ""), { x: i2, text: l2, textRect: x2, isBold: d2 };
            ...
            if (n2.length && e4 === 0 && l2.push(n2.join(a2)), t5.data && t5.data.length)
              for (var s3 = 0; s3 < t5.data.length; s3++) {
                ...
                if (r3 || (c2.isFormatXY() ? r3 = i2[e4].data[s3].x : c2.isFormat2DArray() && (r3 = i2[e4].data[s3] ? i2[e4].data[s3][0] : "")), e4 === 0) {
                  n2.push((d3 = r3, o2.config.xaxis.type === "datetime" && String(d3).length >= 10 ? o2.config.chart.toolbar.export.csv.dateFormatter(r3) : p.isNumber(r3) ? r3 : r3.split(a2).join("")));
    ...
    var G = function() {
      function t2(e2) {
        a(this, t2), this.ctx = e2, this.w = e2.w;
        var i2 = this.w;
        this.axesUtils = new B(e2), this.xaxisLabels = i2.globals.labels.slice(), i2.globals.timescaleLabels.length > 0 && !i2.globals.isBarHorizontal && (this.xaxisLabels = i2.globals.timescaleLabels.slice()), i2.config.xaxis.overwriteCategories && (this.xaxisLabels = i2.config.xaxis.overwriteCategories), this.drawnLabels = [], this.drawnLabelsRects = [], i2.config.xaxis.position === "top" ? this.offY = 0 : this.offY = i2.globals.gridHeight + 1, this.offY = this.offY + i2.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = i2.config.chart.type === "bar" && i2.config.plotOptions.bar.horizontal, this.xaxisFontSize = i2.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = i2.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = i2.config.xaxis.labels.style.colors, this.xaxisBorderWidth = i2.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = i2.config.yaxis[0].axisBorder.width.toString()), this.xaxisBorderWidth.indexOf("%") > -1 ? this.xaxisBorderWidth = i2.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = i2.config.xaxis.axisBorder.height, this.yaxis = i2.config.yaxis[0];
      }
      return r(t2, [{ key: "drawXaxis", value: function() {
        ...
        for (var d2 = function(s3) {
          ...
          s3 === 0 && h2 === 1 && t3 / 2 === o2 && i2.globals.dataPoints === 1 && (l3 = i2.globals.gridWidth / 2);
        ...
        if (g2.show)
          for (var u2 = function(o3) {
            ...
            if (f3.textContent = Array.isArray(n3) ? n3.join(" ") : n3, p3.node.appendChild(f3), s2.config.yaxis[t3].labels.rotate !== 0) {
    ...
    var _ = function() {
      function t2(e2) {
        a(this, t2), this.ctx = e2, this.w = e2.w;
        var i2 = this.w;
        this.xaxisLabels = i2.globals.labels.slice(), this.axesUtils = new B(e2), this.isRangeBar = i2.globals.seriesRangeBar.length, i2.globals.timescaleLabels.length > 0 && (this.xaxisLabels = i2.globals.timescaleLabels.slice());
      }
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        e2 === 0 && l2.globals.skipFirstTimelinelabel || e2 === o2 - 1 && l2.globals.skipLastTimelinelabel && !l2.config.xaxis.labels.formatter || l2.config.chart.type === "radar" || (l2.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i2, y1: a2, x2: s2, y2: r2, parent: n2 }), new G(this.ctx).drawXaxisTicks(i2, this.elg));
    ...
    var j = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        if ((i2 = this._adjustTicksForSmallRange(i2, a2, o2)) === "dataPoints" && (i2 = r2.globals.dataPoints - 1), t3 === Number.MIN_VALUE && e2 === 0 || !p.isNumber(t3) && !p.isNumber(e2) || t3 === Number.MIN_VALUE && e2 === -Number.MAX_VALUE) {
          t3 = 0, e2 = i2;
          ...
          for (var e3 = 0; e3 < t3.series.length; e3++)
            if (t3.labels[e3])
              for (var i3 = 0; i3 < t3.labels[e3].length; i3++)
                t3.labels[e3][i3] !== null && p.isNumber(t3.labels[e3][i3]) && (t3.maxX = Math.max(t3.maxX, t3.labels[e3][i3]), t3.initialMaxX = Math.max(t3.maxX, t3.labels[e3][i3]), t3.minX = Math.min(t3.minX, t3.labels[e3][i3]), t3.initialMinX = Math.min(t3.minX, t3.labels[e3][i3]));
          ...
          for (var e2 = 0; e2 < t3.series.length; e2++)
            if (t3.seriesZ[e2] !== void 0)
              for (var i2 = 0; i2 < t3.seriesZ[e2].length; i2++)
                t3.seriesZ[e2][i2] !== null && p.isNumber(t3.seriesZ[e2][i2]) && (t3.maxZ = Math.max(t3.maxZ, t3.seriesZ[e2][i2]), t3.minZ = Math.min(t3.minZ, t3.seriesZ[e2][i2]));
        }
        ...
        if (t3.series.length)
          for (var a2 = 0; a2 < t3.series[t3.maxValsInArrayIndex].length; a2++)
            for (var s2 = 0, r2 = 0, o2 = 0; o2 < t3.series.length; o2++)
              t3.series[o2][a2] !== null && p.isNumber(t3.series[o2][a2]) && (t3.series[o2][a2] > 0 ? s2 = s2 + parseFloat(t3.series[o2][a2]) + 1e-4 : r2 += parseFloat(t3.series[o2][a2])), o2 === t3.series.length - 1 && (e2.push(s2), i2.push(r2));
    ...
    var at = function() {
      ...
      return r(t2, [{ key: "getxAxisLabelsCoords", value: function() {
        ...
        if (e2.config.xaxis.convertedCatToNumeric && i2.length === 0 && (i2 = e2.globals.categoryLabels), e2.globals.timescaleLabels.length > 0) {
          ...
          r2 = n2.xLabelFormat(s2, r2, l2, { i: void 0, dateFormatter: new Y(this.dCtx.ctx).formatDate, w: e2 }), o2 = n2.xLabelFormat(s2, o2, l2, { i: void 0, dateFormatter: new Y(this.dCtx.ctx).formatDate, w: e2 }), (e2.config.xaxis.convertedCatToNumeric && r2 === void 0 || String(r2).trim() === "") && (o2 = r2 = "1");
    ...
    var ot = function() {
      ...
      return r(t2, [{ key: "plotCoords", value: function() {
        ...
        var h2 = 10;
        (e2.config.chart.type === "radar" || this.isSparkline) && (n2 = 0, l2 = i2.goldenPadding), this.isSparkline && (this.lgRect = { height: 0, width: 0 }), (this.isSparkline || e2.config.chart.type === "treemap") && (n2 = 0, l2 = 0, h2 = 0), this.isSparkline || this.dimXAxis.additionalPaddingXLabels(r2);
        var c2 = function() {
          i2.translateX = n2, i2.gridHeight = i2.svgHeight - t3.lgRect.height - l2 - (t3.isSparkline || e2.config.chart.type === "treemap" ? 0 : e2.globals.rotateXLabels ? 10 : 15), i2.gridWidth = i2.svgWidth - n2;
        };
        ...
        var i2 = this.w, a2 = t3.height + e2.height, s2 = i2.globals.isMultiLineX ? 1.2 : i2.globals.LINE_HEIGHT_RATIO, r2 = i2.globals.rotateXLabels ? 22 : 10, o2 = i2.globals.rotateXLabels && i2.config.legend.position === "bottom" ? 10 : 0;
    ...
    var lt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if ((i2.legend.showForSingleSeries && e2.series.length === 1 || this.isBarsDistributed || e2.series.length > 1 || !e2.axisCharts) && i2.legend.show) {
          ...
          this.drawLegends(), p.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), i2.legend.position === "bottom" || i2.legend.position === "top" ? this.legendAlignHorizontal() : i2.legend.position !== "right" && i2.legend.position !== "left" || this.legendAlignVertical();
        }
      ...
      return r(i2, [{ key: "init", value: function(t3) {
        ...
        if (a2.config.yaxis.forEach(function(t4, e4) {
          ...
          if (a2.globals.zoomEnabled) {
            ...
            var m2, y2 = null;
            m2 = { min: h2, max: c2 }, i3 !== "xy" && i3 !== "y" || (y2 = p.clone(a2.config.yaxis)).forEach(function(t4, e4) {
    ...
    var dt = function() {
      ...
      return r(t2, [{ key: "getNearestValues", value: function(t3) {
        ...
        if (y2 = y2.map(function(t4) {
          ...
          v2 = (m2 = this.closestInMultiArray(A2, S2, y2, b2)).index, f2 = m2.j, v2 !== null && (y2 = r2.globals.seriesXvalues[v2], f2 = (m2 = this.closestInArray(A2, y2)).index);
        }
        return r2.globals.capturedSeriesIndex = v2 === null ? -1 : v2, (!f2 || f2 < 1) && (f2 = 0), r2.globals.isBarHorizontal ? r2.globals.capturedDataPointIndex = x2 : r2.globals.capturedDataPointIndex = f2, { capturedSeries: v2, j: r2.globals.isBarHorizontal ? x2 : f2, hoverX: g2, hoverY: u2 };
    ...
    var gt = function() {
      ...
      return r(t2, [{ key: "drawSeriesTexts", value: function(t3) {
        ...
        p2 !== null && (a2[e2].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = l2.config.tooltip.z.title, a2[e2].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = p2 !== void 0 ? p2 : "");
      ...
      return r(t2, [{ key: "getAttr", value: function(t3, e2) {
        ...
        if (e2.target.classList.contains("apexcharts-".concat(r2, "-rect"))) {
          ...
          if (o2.tooltipLabels.drawSeriesTexts({ ttItems: i2.ttItems, i: l2, j: h2, shared: false, e: e2 }), n2.globals.capturedSeriesIndex = l2, n2.globals.capturedDataPointIndex = h2, a2 = c2 + o2.tooltipRect.ttWidth / 2 + g2, s2 = d2 + o2.tooltipRect.ttHeight / 2 - u2 / 2, o2.tooltipPosition.moveXCrosshairs(c2 + g2 / 2), a2 > n2.globals.gridWidth / 2 && (a2 = c2 - o2.tooltipRect.ttWidth / 2 + g2), o2.w.config.tooltip.followCursor) {
            ...
            a2 = n2.globals.clientX - p2.left - (a2 > n2.globals.gridWidth / 2 ? o2.tooltipRect.ttWidth : 0), s2 = n2.globals.clientY - p2.top;
          }
        }
        return { x: a2, y: s2 };
        ...
        if (o2) {
          if (i2.tooltipRect = { x: 0, y: 0, ttWidth: o2.getBoundingClientRect().width, ttHeight: o2.getBoundingClientRect().height }, i2.e = s2, i2.tooltipUtil.hasBars() && !r2.globals.comboCharts && !i2.isBarShared) {
            if (this.tConfig.onDatasetHover.highlightDataSeries)
              new z(e2).toggleSeriesOnHover(s2, s2.target.parentNode);
          }
    ...
    var mt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        var a2 = this, s3 = this.w, r2 = new b(this.ctx), o2 = new L(this.ctx);
        ...
        for (var l2 = r2.group({ class: "apexcharts-".concat(s3.config.chart.type, "-series apexcharts-plot-series") }), h2 = function(n3) {
          ...
          var h3, c3, d2, g2, u2 = void 0, f2 = void 0, x2 = [], b2 = [], v2 = s3.globals.comboCharts ? i3[n3] : n3, m2 = r2.group({ class: "apexcharts-series", seriesName: p.escapeString(s3.globals.seriesNames[v2]), rel: n3 + 1, "data:realIndex": v2 });
          ...
          for (var A2 = r2.group({ class: "apexcharts-datalabels", "data:realIndex": v2 }), S2 = function(i4) {
            var r3 = a2.barHelpers.getStrokeWidth(n3, i4, v2), l3 = null, p2 = { indexes: { i: n3, j: i4, realIndex: v2 }, x: u2, y: f2, strokeWidth: r3, elSeries: m2 };
            l3 = a2.isHorizontal ? a2.drawHorizontalBoxPaths(e(e({}, p2), {}, { yDivision: c3, barHeight: y2, zeroW: g2 })) : a2.drawVerticalBoxPaths(e(e({}, p2), {}, { xDivision: h3, barWidth: w2, zeroH: d2 })), f2 = l3.y, u2 = l3.x, i4 > 0 && b2.push(u2 + w2 / 2), x2.push(f2), l3.pathTo.forEach(function(e2, h4) {
            ...
            S2(C2);
          s3.globals.seriesXvalues[v2] = b2, s3.globals.seriesYvalues[v2] = x2, l2.add(m2);
        ...
        this.series[h2][c2] === void 0 || this.series[h2][c2] === null ? (w2 = r2, k2 = r2) : (w2 = r2 - w2 / f2, k2 = r2 - k2 / f2, m2 = r2 - v2.h / f2, y2 = r2 - v2.l / f2, A2 = r2 - v2.m / f2);
        ...
        var e2 = t3.indexes;
        t3.x;
        var i3 = t3.y, a2 = t3.yDivision, s3 = t3.barHeight, r2 = t3.zeroW, o2 = t3.strokeWidth, n2 = this.w, l2 = new b(this.ctx), h2 = e2.i, c2 = e2.j, d2 = this.boxOptions.colors.lower;
        this.isBoxPlot && (d2 = [this.boxOptions.colors.lower, this.boxOptions.colors.upper]);
        var g2 = this.invertedYRatio, u2 = e2.realIndex, p2 = this.getOHLCValue(u2, c2), f2 = r2, x2 = r2, v2 = Math.min(p2.o, p2.c), m2 = Math.max(p2.o, p2.c), y2 = p2.m;
        n2.globals.isXNumeric && (i3 = (n2.globals.seriesX[u2][c2] - n2.globals.minX) / this.invertedXRatio - s3 / 2);
        var w2 = i3 + s3 * this.visibleI;
        this.series[h2][c2] === void 0 || this.series[h2][c2] === null ? (v2 = r2, m2 = r2) : (v2 = r2 + v2 / g2, m2 = r2 + m2 / g2, f2 = r2 + p2.h / g2, x2 = r2 + p2.l / g2, y2 = r2 + p2.m / g2);
        var k2 = l2.move(r2, w2), A2 = l2.move(v2, w2 + s3 / 2);
        return n2.globals.previousPaths.length > 0 && (A2 = this.getPreviousPath(u2, c2, true)), k2 = [l2.move(v2, w2) + l2.line(v2, w2 + s3 / 2) + l2.line(f2, w2 + s3 / 2) + l2.line(f2, w2 + s3 / 2 - s3 / 4) + l2.line(f2, w2 + s3 / 2 + s3 / 4) + l2.line(f2, w2 + s3 / 2) + l2.line(v2, w2 + s3 / 2) + l2.line(v2, w2 + s3) + l2.line(y2, w2 + s3) + l2.line(y2, w2) + l2.line(v2 + o2 / 2, w2), l2.move(y2, w2) + l2.line(y2, w2 + s3) + l2.line(m2, w2 + s3) + l2.line(m2, w2 + s3 / 2) + l2.line(x2, w2 + s3 / 2) + l2.line(x2, w2 + s3 - s3 / 4) + l2.line(x2, w2 + s3 / 4) + l2.line(x2, w2 + s3 / 2) + l2.line(m2, w2 + s3 / 2) + l2.line(m2, w2) + l2.line(y2, w2) + "z"], A2 += l2.move(v2, w2), n2.globals.isXNumeric || (i3 += a2), { pathTo: k2, pathFrom: A2, x: m2, y: i3, barYPosition: w2, color: d2 };
    ...
    var yt = function() {
      ...
      return r(t2, [{ key: "checkColorRange", value: function() {
        ...
        return s2.config.plotOptions[t3].enableShades && (l2 = this.w.config.theme.mode === "dark" ? p.hexToRgba(h2.shadeColor(-1 * r2, n2.color), s2.config.fill.opacity) : p.hexToRgba(h2.shadeColor(r2, n2.color), s2.config.fill.opacity)), { color: l2, colorProps: n2 };
    ...
    var At = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3) {
        ...
        return e2.chartType === "donut" ? [].concat(b2, ["L", u2.x, u2.y, "A", e2.donutSize, e2.donutSize, 0, x2, 0, f2.x, f2.y, "L", h2, c2, "z"]).join(" ") : e2.chartType === "pie" || e2.chartType === "polarArea" ? [].concat(b2, ["L", e2.centerX, e2.centerY, "L", h2, c2]).join(" ") : [].concat(b2).join(" ");
        ...
        if (r2 ? (o2 = t3.total.color, c2 = t3.total.fontSize, d2 = t3.total.fontFamily, g2 = t3.total.fontWeight, f2 = t3.total.label, p2 = t3.total.formatter(i2)) : i2.globals.series.length === 1 && (p2 = u2(i2.globals.series[0], i2), f2 = i2.globals.seriesNames[0]), f2 && (f2 = t3.name.formatter(f2, t3.total.show, i2)), t3.name.show) {
      ...
      return r(t2, [{ key: "draw", value: function(t3) {
        ...
        if (this.yaxisLabels = this.graphics.group({ class: "apexcharts-yaxis" }), t3.forEach(function(t4, n3) {
          ...
          for (var v2 = 0; v2 < c3.linePathsTo.length; v2++) {
            var m2 = i2.graphics.renderPaths(e(e({}, d3), {}, { pathFrom: b3 === null ? c3.linePathsFrom[v2] : b3, pathTo: c3.linePathsTo[v2], strokeWidth: Array.isArray(i2.strokeWidth) ? i2.strokeWidth[n3] : i2.strokeWidth, fill: "none", drawShadow: false }));
            h3.add(m2);
            var y2 = s2.fillPath({ seriesNumber: n3 }), w2 = i2.graphics.renderPaths(e(e({}, d3), {}, { pathFrom: b3 === null ? c3.areaPathsFrom[v2] : b3, pathTo: c3.areaPathsTo[v2], strokeWidth: 0, fill: y2, drawShadow: false }));
    ...
    var Pt = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (o2.config.stroke.show && !this.pointsChart) {
          var v2 = null;
          v2 = i2 === "line" ? l2.fillPath({ seriesNumber: a2, i: s2 }) : o2.globals.stroke.colors[a2];
        ...
        for (var e2 = t3.series, i2 = t3.realIndex, a2 = t3.i, s2 = t3.x, r2 = t3.y, o2 = t3.pX, n2 = t3.pY, l2 = t3.pathsFrom, h2 = t3.linePaths, c2 = t3.areaPaths, d2 = t3.seriesIndex, g2 = t3.lineYPosition, u2 = t3.xArrj, f2 = t3.yArrj, x2 = this.w, v2 = new b(this.ctx), m2 = this.yRatio, y2 = l2.prevY, w2 = l2.linePath, k2 = l2.areaPath, A2 = l2.pathFromLine, S2 = l2.pathFromArea, C2 = p.isNumber(x2.globals.minYArr[i2]) ? x2.globals.minYArr[i2] : x2.globals.minY, L2 = x2.globals.dataPoints > 1 ? x2.globals.dataPoints - 1 : x2.globals.dataPoints, P2 = 0; P2 < L2; P2++) {
          ...
          if (x2.globals.isXNumeric) {
            ...
            x2.globals.seriesX[i2][P2 + 1] === void 0 && (M2 = x2.globals.seriesX[i2][L2 - 1]), s2 = (M2 - x2.globals.minX) / this.xRatio;
          } else
            s2 += this.xDivision;
        ...
        if (Array.isArray(p2.config.stroke.curve) && (x2 = Array.isArray(u2) ? p2.config.stroke.curve[u2[i2]] : p2.config.stroke.curve[i2]), x2 === "smooth") {
          var m2 = 0.35 * (r2 - n2);
          p2.globals.hasNullValues ? (e2[i2][s2] !== null && (e2[i2][s2 + 1] !== null ? (h2 = f2.move(n2, l2) + f2.curve(n2 + m2, l2, r2 - m2, o2, r2 + 1, o2), c2 = f2.move(n2 + 1, l2) + f2.curve(n2 + m2, l2, r2 - m2, o2, r2 + 1, o2) + f2.line(r2, v2) + f2.line(n2, v2) + "z") : (h2 = f2.move(n2, l2), c2 = f2.move(n2, l2) + "z")), d2.push(h2), g2.push(c2)) : (h2 += f2.curve(n2 + m2, l2, r2 - m2, o2, r2, o2), c2 += f2.curve(n2 + m2, l2, r2 - m2, o2, r2, o2)), n2 = r2, l2 = o2, s2 === e2[i2].length - 2 && (c2 = c2 + f2.curve(n2, l2, r2, o2, r2, v2) + f2.move(r2, o2) + "z", p2.globals.hasNullValues || (d2.push(h2), g2.push(c2)));
        } else {
          if (e2[i2][s2 + 1] === null) {
            h2 += f2.move(r2, o2);
          ...
          e2[i2][s2] === null && (h2 += f2.move(r2, o2), c2 += f2.move(r2, v2)), x2 === "stepline" ? (h2 = h2 + f2.line(r2, null, "H") + f2.line(null, o2, "V"), c2 = c2 + f2.line(r2, null, "H") + f2.line(null, o2, "V")) : x2 === "straight" && (h2 += f2.line(r2, o2), c2 += f2.line(r2, o2)), s2 === e2[i2].length - 2 && (c2 = c2 + f2.line(r2, v2) + f2.move(r2, o2) + "z", d2.push(h2), g2.push(c2));
        }
    ...
    var zt = function() {
      ...
      return r(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, i2) {
        ...
        if (e2.minDate > 1 || e2.minMonth > 0) {
          ...
          e2.minDate === 1 && e2.minMonth === 0 && this.timeScaleArray.push({ position: n2, value: o2, unit: h2, year: a2, month: p.monthMod(i2 + 1) });
        ...
        for (var x2 = n2 + 1, b2 = l2, v2 = 0, m2 = 1; v2 < o2; v2++, m2++) {
          (x2 = p.monthMod(x2)) === 0 ? (c2 = "year", d2 += 1) : c2 = "month";
        ...
        e2.minHour === 0 && e2.minDate === 1 ? (d2 = 0, g2 = p.monthMod(e2.minMonth), n2 = "month", h2 = e2.minDate, r2++) : e2.minDate !== 1 && e2.minHour === 0 && e2.minMinute === 0 && (d2 = 0, l2 = e2.minDate, g2 = l2, u2 = c2(h2 = l2, i2, a2)), this.timeScaleArray.push({ position: d2, value: g2, unit: n2, year: this._getYear(a2, u2, 0), month: p.monthMod(u2), day: h2 });
        for (var f2 = d2, x2 = 0; x2 < r2; x2++) {
          n2 = "day", u2 = c2(h2 += 1, u2, this._getYear(a2, u2, 0));
          var b2 = this._getYear(a2, u2, 0);
          f2 = 24 * s2 + f2;
          var v2 = h2 === 1 ? p.monthMod(u2) : h2;
        ...
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.minutesWidthOnXAxis, h2 = t3.secondsWidthOnXAxis, c2 = t3.numberOfMinutes, d2 = a2 + 1, g2 = r2, u2 = o2, f2 = n2, x2 = s2, b2 = (60 - i2 - e2 / 1e3) * h2, v2 = 0; v2 < c2; v2++)
          d2 >= 60 && (d2 = 0, (x2 += 1) === 24 && (x2 = 0)), this.timeScaleArray.push({ position: b2, value: d2, unit: "minute", hour: x2, minute: d2, day: g2, year: this._getYear(f2, u2, 0), month: p.monthMod(u2) }), b2 += l2, d2++;
        ...
        for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, o2 = t3.currentMonth, n2 = t3.currentYear, l2 = t3.secondsWidthOnXAxis, h2 = t3.numberOfSeconds, c2 = i2 + 1, d2 = a2, g2 = r2, u2 = o2, f2 = n2, x2 = s2, b2 = (1e3 - e2) / 1e3 * l2, v2 = 0; v2 < h2; v2++)
          c2 >= 60 && (c2 = 0, ++d2 >= 60 && (d2 = 0, ++x2 === 24 && (x2 = 0))), this.timeScaleArray.push({ position: b2, value: c2, unit: "second", hour: x2, minute: d2, second: c2, day: g2, year: this._getYear(f2, u2, 0), month: p.monthMod(u2) }), b2 += l2, c2++;
    ...
    var Xt = function() {
      ...
      return r(t2, [{ key: "setupElements", value: function() {
        ...
        a2 === "%" ? p.isNumber(i2[0]) && (i2[0].width === 0 && (i2 = p.getDimensions(this.el.parentNode)), t3.svgWidth = i2[0] * parseInt(e2.chart.width, 10) / 100) : a2 !== "px" && a2 !== "" || (t3.svgWidth = parseInt(e2.chart.width, 10));
      ...
      return r(t2, [{ key: "_updateOptions", value: function(t3) {
        ...
        return new Promise(function(n2) {
          ...
          r2 && (l2 = e2.ctx.getSyncedCharts()), e2.ctx.w.globals.isExecCalled && (l2 = [e2.ctx], e2.ctx.w.globals.isExecCalled = false), l2.forEach(function(r3, h2) {
            var c2 = r3.w;
            return c2.globals.shouldAnimate = s2, a2 || (c2.globals.resized = true, c2.globals.dataChanged = true, s2 && r3.series.getPreviousPaths()), t3 && i(t3) === "object" && (r3.config = new H(t3), t3 = y.extendArrayProps(r3.config, t3, c2), r3.w.globals.chartID !== e2.ctx.w.globals.chartID && delete t3.series, c2.config = p.extend(c2.config, t3), o2 && (c2.globals.lastXAxis = t3.xaxis ? p.clone(t3.xaxis) : [], c2.globals.lastYAxis = t3.yaxis ? p.clone(t3.yaxis) : [], c2.globals.initialConfig = p.extend({}, c2.config), c2.globals.initialSeries = p.clone(c2.config.series))), r3.update(t3).then(function() {
        ...
        return new Promise(function(s2) {
          ...
          })).length === 0 && (r2 = [{ data: [] }]), o2.config.series = r2) : o2.config.series = t3.slice(), a2 && (o2.globals.initialSeries = p.clone(o2.config.series)), i2.ctx.update().then(function() {
            s2(i2.ctx);
          });
        });
        ...
        return i2.globals.axisCharts ? a2 = i2.globals.dom.Paper.select("".concat(s2, " path[j='").concat(e2, "'], ").concat(s2, " circle[j='").concat(e2, "'], ").concat(s2, " rect[j='").concat(e2, "']")).members[0] : e2 === void 0 && (a2 = i2.globals.dom.Paper.select("".concat(s2, " path[j='").concat(t3, "']")).members[0], i2.config.chart.type !== "pie" && i2.config.chart.type !== "polarArea" && i2.config.chart.type !== "donut" || this.ctx.pie.pieClicked(t3)), a2 ? (new b(this.ctx).pathMouseDown(a2, null), a2.node ? a2.node : null) : (console.warn("toggleDataPointSelection: Element not found"), null);
    ...
    Tt = typeof window != "undefined" ? window : void 0, Mt = function(t2, e2) {
    ...
    }) : (typeof exports == "undefined" ? "undefined" : i(exports)) === "object" && typeof module != "undefined" ? module.exports = Tt.document ? Mt(Tt, Tt.document) : function(t2) {
      ...
      function t2(t3, s3, r2, o2, n2, l2, h2) {
        for (var c2 = t3.slice(s3, r2 || h2), d2 = o2.slice(n2, l2 || h2), g2 = 0, u2 = { pos: [0, 0], start: [0, 0] }, p2 = { pos: [0, 0], start: [0, 0] }; ; ) {
          if (c2[g2] = e2.call(u2, c2[g2]), d2[g2] = e2.call(p2, d2[g2]), c2[g2][0] != d2[g2][0] || c2[g2][0] == "M" || c2[g2][0] == "A" && (c2[g2][4] != d2[g2][4] || c2[g2][5] != d2[g2][5]) ? (Array.prototype.splice.apply(c2, [g2, 1].concat(a2.call(u2, c2[g2]))), Array.prototype.splice.apply(d2, [g2, 1].concat(a2.call(p2, d2[g2])))) : (c2[g2] = i2.call(u2, c2[g2]), d2[g2] = i2.call(p2, d2[g2])), ++g2 == c2.length && g2 == d2.length)
            break;
      ...
      return r(t2, [{ key: "render", value: function() {
        ...
        return new Promise(function(e2, i2) {
          if (t3.el !== null) {
            ...
            if (typeof a2 == "function" && a2(t3, t3.w), t3.events.fireEvent("beforeMount", [t3, t3.w]), window.addEventListener("resize", t3.windowResizeHandler), h2 = t3.el.parentNode, c2 = t3.parentResizeHandler, d2 = false, g2 = new ResizeObserver(function(t4) {
        ...
        return new Promise(function(s2, r2) {
          ...
          i2.annotations = new C(i2), i2.annotations.drawImageAnnos(), i2.annotations.drawTextAnnos(), a2.config.grid.position === "back" && o2 && a2.globals.dom.elGraphical.add(o2.el);
