...
var require_v_click_outside_umd = __commonJS({
  "node_modules/click-outside-vue3/dist/v-click-outside.umd.js"(exports, module) {
    init_define_process_env();
    !function(e, n) {
      typeof exports == "object" && typeof module != "undefined" ? module.exports = n() : typeof define == "function" && define.amd ? define(n) : (e || self)["v-click-outside"] = n();
    }(exports, function() {
      var e = "__v-click-outside", n = typeof window != "undefined", t = typeof navigator != "undefined", r = n && ("ontouchstart" in window || t && navigator.msMaxTouchPoints > 0) ? ["touchstart"] : ["click"], i = function(e2) {
        var n2 = e2.event, t2 = e2.handler;
        (0, e2.middleware)(n2) && t2(n2);
      }, a = function(n2, t2) {
        var a2 = function(e2) {
          var n3 = typeof e2 == "function";
          if (!n3 && typeof e2 != "object")
            throw new Error("v-click-outside: Binding value must be a function or an object");
          return { handler: n3 ? e2 : e2.handler, middleware: e2.middleware || function(e3) {
            return e3;
          }, events: e2.events || r, isActive: !(e2.isActive === false), detectIframe: !(e2.detectIframe === false), capture: Boolean(e2.capture) };
            ...
            var l = { event: "blur", srcTarget: window, handler: function(e2) {
              return function(e3) {
                ...
                setTimeout(function() {
                  ...
                  e4 && e4.tagName === "IFRAME" && !n3.contains(e4) && i({ event: t3, handler: r2, middleware: a3 });
                }, 0);
...
// dep:click-outside-vue3
init_define_process_env();
var click_outside_vue3_default = require_v_click_outside_umd();
export {
  click_outside_vue3_default as default
};
