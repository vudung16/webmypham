                    ...
                    <div class="content">
                        ...
                        <div class="up-down" v-if="(countData.total.precent_order_money).charAt(0) === '+'">
                            <span>
                                <svg width="10" height="10" viewBox="0 0 8 8" fill="none"
                                    ...
                                    <path d="M1 6.33333L6.33333 1" stroke="#5DC2CC" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1.66699 1H6.33366V5.66667" stroke="#5DC2CC" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                            <span class="up">&nbsp;{{ parseInt(countData.total.precent_order_money) }}% &nbsp;</span>
                        ...
                        <div class="up-down" v-else>
                            <span>
                                <svg width="10" height="10" viewBox="0 0 8 8" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.33398 0.999919L1.00065 6.33325" stroke="#FF6F6F" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M5.66699 6.33325L1.00033 6.33325L1.00032 1.66659" stroke="#FF6F6F"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </span>
                            <span class="down">&nbsp;{{ parseInt(countData.total.precent_order_money) }}%
                                &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                    </div>
                ...
                <div class="report-text">
                    <div class="content">
                        ...
                        <div class="up-down" v-if="(countData.total.precent_user_count).charAt(0) === '+'">
                            ...
                            <span class="up">&nbsp;+{{ parseInt(countData.total.precent_user_count) }}% &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                        <div class="up-down" v-else>
                            <span>
                            ...
                            <span class="down">&nbsp;{{ parseInt(countData.total.precent_user_count) }}% &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                    </div>
                    <div class="img">
                ...
                <div class="report-text">
                    <div class="content">
                        ...
                        <div class="up-down" v-if="(countData.total.precent_rate_count).charAt(0) === '+'">
                            ...
                            <span class="up">&nbsp;+{{ parseInt(countData.total.precent_rate_count) }}% &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                        <div class="up-down" v-else>
                            <span>
                            ...
                            <span class="down">&nbsp;{{ parseInt(countData.total.precent_rate_count) }}% &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                    </div>
                    <div class="img">
                ...
                <div class="report-text">
                    <div class="content">
                        ...
                        <div class="up-down" v-if="(countData.total.precent_order_count).charAt(0) === '+'">
                            ...
                            <span class="up">&nbsp;+{{ parseInt(countData.total.precent_order_count) }}% &nbsp;</span>
                            <span> so với {{ time }}</span>
                        </div>
                        <div class="up-down" v-else>
                            <span>
                            ...
                            <span class="down">&nbsp;{{ parseInt(countData.total.precent_order_count) }}% &nbsp;</span>
                            <span>so với {{ time }}</span>
                        </div>
                    </div>
                    <div class="img">
